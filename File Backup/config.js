...
const OWNER_NAME   = 'iky';
const NOMOR_BOT    = '6285778010372'; // 628xx nomor wa
...
const EMAIL        = 'iky@gmail.com';
const REGION       = 'Indonesia';
const WEBSITE      = 'iky.com';
const DATA_OWNER = ["6281299703311"]; // bisa juga edit di database/owner.json
